        ...
        <>
            <div className="text-center p-5 bg-custom-blue text-white">
                ...
                <div className="flex flex-wrap items-center mt-20 text-center">
                    <div className="w-full md:w-3/5 lg:w-1/2 px-4 border-white">
                        <img
                            src="https://images.pexels.com/photos/6646816/pexels-photo-6646816.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                            alt="gem"
                            className="aboutUs-image inline-block rounded shadow-lg hover:shadow-xl transition-all transform hover:scale-105 duration-500 ease-in-out"
                        />
                    </div>
