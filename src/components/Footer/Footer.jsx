                    ...
                    <div className="container px-4 mx-auto">
                        <div className="-mx-4 flex flex-wrap justify-between">
                            <div className="px-4 my-4 w-full xl:w-1/5">
                                ...
                                AFSA is a not for profit , non-political and social development organization established in 2022 dedicating to enhance the quality of lives of rural and urban poor in INDIA.
                                </p>
                            </div>
                            ...
                            <div className="px-4 my-4 w-full sm:w-auto">
                                ...
                                <ul className="leading-8">
                                    <li><a href="#" className="hover:text-custom-blue">Home</a></li>
                                    <li><a href="#" className="hover:text-blue-400">About Us</a></li>
                                    <li><a href="#" className="hover:text-blue-400">Our Team</a></li>
                                    <li><a href="#" className="hover:text-blue-400">Our Work</a></li>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="-mx-4 flex flex-wrap justify-between">
                            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                                Copyright ©2024
                                Aryalex Foundation. All Rights Reserved.
                            </div>
                        </div>
                    </div>
                </div>
