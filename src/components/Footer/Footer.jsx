...
function Footer({ heroRef, factsRef, aboutUsRef, visionRef, ourTeamRef, ourWorkRef, galleryRef, contactusRef, donateRef }) {
    // Create a function to handle smooth scroll when clicking on a link
    ...
    return (
        <footer className='bg-custom-blue pt-16'>
            <div className="bg-gray-800 py-4 text-gray-400 pt-10">
                <div className="container px-4 mx-auto">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 my-4 w-full xl:w-1/5">
                            <a href="/" className="block w-56 mb-10">
                                <img src={logo} alt="AFSA" className='h-20 w-56 rounded-md' />
                            </a>
                            <p className="text-justify">
                                AFSA is a not-for-profit, non-political and social development organization established in 2022, dedicated to enhancing the quality of lives of rural and urban poor in India.
                            </p>
                        </div>
                        <div className="px-4 my-4 w-full sm:w-auto">
                            <div>
                                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-custom-blue">Quick Links</h2>
                            </div>
                            <ul className="leading-8">
                                <li><a href="#herosection" className="hover:text-custom-blue">Home</a></li>
                                <li><a href="#aboutus" className="hover:text-blue-400">About Us</a></li>
                                <li><a href="#ourteam" className="hover:text-blue-400">Our Team</a></li>
                                <li><a href="#ourwork" className="hover:text-blue-400">Our Work</a></li>
            ...
            <div className="bg-custom-blue py-4 text-gray-100">
                <div className="container mx-auto px-4">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                            Copyright ©2024 Aryalex Foundation. All Rights Reserved.
                        </div>
                    </div>
                </div>
            </div>
